...
const NewEvent = props => {
  ...
  useEffect(() => {
    ...
    const fetchUploadedEventImageRefs = 
      ...
      console.log(uploadedEventImageURLs);
      setTimeout(function(){
  ...
  function CheckValidInput(){
    ...
    else if(newEventImageUploadInputRef.current.files[0] === undefined &&
      selectedEventImageURL === ''){
        validInput = false;
    }
  ...
  function RecursiveCreateNewEvent(eventID, nextEventDate, endDate, imageURL){
    ...
    if(endDate != null && repeatsInputRef.current.checked && repeatTimeFrameSelectRef.current.value === 'Weekly'){
        ...
        <div id='newEventContainerDiv'>
          ...
          <div id='newEventInfoContainerDiv'>
            ...
            <div id='newEventDescriptionDiv' className='newEventInfoDiv'>
              ...
              <textarea id='newEventDescriptionInput' ref={newEventDescriptionInputRef} maxLength={150} rows={6} onChange={CheckValidInput}/>
            </div>
            <div id='newEventImageDiv' className='newEventInfoDiv'>
              <label htmlFor='newEventImageUploadInput' className='newEventInfoLabel'>Event Image:</label>
      ...
      <div id='repeatsDiv'>
        <div id='repeatsInfoDiv'>
          ...
          <div id='repeatsTimeFrameSelectDiv'>
            <select id='repeatsTimeFrameSelect' ref={repeatTimeFrameSelectRef} defaultValue={'None'} size={1} disabled>
          ...
          <div id='repeatsEndDateDiv'>
            ...
            <input type='date' id='repeatsEndDateInput' ref={repeatsEndDateInputRef} disabled/>
          </div>
        </div>
      </div>
      <div id='selectImageAndSubmit'>
